...
echo "Conducty — Installing for OpenCode"
echo ""
...
echo ""
echo "OpenCode discovers skills from ~/.config/opencode/skills/ automatically."
echo "Use the native 'skill' tool to list and load skills."
echo ""
echo "Tool mapping (Cursor -> OpenCode):"
echo "  TodoWrite -> todowrite"
echo "  Task (subagents) -> @mention"
echo "  Read/Write/Edit -> native file tools"
echo "  Shell -> native bash tool"
echo ""
